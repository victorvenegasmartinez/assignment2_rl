...
# `make collect_submission`
#   Removes existing submission zip file, recreates it with most recent copies of
#   submission files.
# `make clean`
...
.PHONY: clean collect_submission with_solutions without_solutions
